...
public class GameBoard : MonoBehaviour {
    ...
    //used to record all the contents with events.
	...
	public void Initialize (
        ...
        // instantiate tile prefabs and make relatioships
		for (int i = 0, y = 0; y < size.y; y++) {
			for (int x = 0; x < size.x; x++, i++) {
                ...
                //alternative is to use checker board to drive arrows in better order
